trigger SDO_Service_defaultEntitlement on Case (Before Insert, Before Update) {
    /*
...
*/
    ...
    for (Case newCase : Trigger.new){
        if (newCase.EntitlementId == null && (newCase.ContactId != null || newCase.AccountId != null)){
            ...
            Entitlement entitlement = [SELECT AccountId,Id, Name FROM Entitlement WHERE AccountId = :ohana.Id AND Name = 'Premium Service' AND Status = 'Active' LIMIT 1];
