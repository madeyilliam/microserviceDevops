trigger SDO_Service_completeFirstResponseCaseComment on CaseComment (after insert) {
        ...
        if (caseIds.isEmpty() == false){
            ...
            if (caseList.isEmpty() == false){
                ...
                if(updateCases.isEmpty() == false)
                    SDO_Service_milestoneUtils.completeMilestone(updateCases, 'First Response', completionDate); 
            }
        }
    }
}